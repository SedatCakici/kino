...
public class Main {
	...
	public static void main(String[] args) throws IllegalTimeException {
		...
		filme[0] = new Film("Jack Reacher: Kein Weg zurÃ¼ck", "118", Alterbeschrankung.Ab16Jahren, new Zeit("14:30"), blauerSaal);
		filme[1] = new Film("Jack Reacher: Kein Weg zurÃ¼ck", "118", Alterbeschrankung.Ab16Jahren, new Zeit("17:00"), blauerSaal);
		filme[2] = new Film("Jack Reacher: Kein Weg zurÃ¼ck", "118", Alterbeschrankung.Ab16Jahren, new Zeit("19:30"), blauerSaal);
		filme[3] = new Film("Jack Reacher: Kein Weg zurÃ¼ck", "118", Alterbeschrankung.Ab16Jahren, new Zeit("22:00"), blauerSaal);

		filme[4] = new Film("Tschick", "93", Alterbeschrankung.Ab12Jahren, new Zeit("15:00"), gruenerSaal);
		filme[5] = new Film("Doctor Strange", "115", Alterbeschrankung.Ab12Jahren, new Zeit("17:00"), gruenerSaal);
		filme[6] = new Film("Doctor Strange", "115", Alterbeschrankung.Ab12Jahren, new Zeit("19:30"), gruenerSaal);
		filme[7] = new Film("Before I Wake", "96", Alterbeschrankung.Ab16Jahren, new Zeit("22:00"), gruenerSaal);

		filme[8] = new Film("Adam Misin!", "91", Alterbeschrankung.Ab6Jahren, new Zeit("15:00"), studio);
		filme[9] = new Film("Arrival", "116", Alterbeschrankung.Ab12Jahren, new Zeit("17:00"), studio);
		filme[10] = new Film("Dirty Cops: War On Everyone", "98", Alterbeschrankung.Ab6Jahren, new Zeit("19:30"), studio);
		filme[11] = new Film("Die Mitte der Welt", "115", Alterbeschrankung.Ab12Jahren, new Zeit("14:30"), studio);

		filme[12] = new Film("Caf Ì�e Society", "96", Alterbeschrankung.Ab0Jahren, new Zeit("20:00"), kellerloch);
		filme[13] = new Film("German Angst", "107", Alterbeschrankung.Ab18Jahren, new Zeit("22:00"), kellerloch);
